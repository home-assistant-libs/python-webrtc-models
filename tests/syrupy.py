...
class CustomSnapshotSerializer(AmberDataSerializer):
    """Custom snapshot serializer for Syrupy.

    Handles special cases for data structures.
    """
    ...
    def _serialize(  # pylint: disable=too-many-arguments
        ...
        *,
        ...
        This allows us to handle specific cases for data structures.
        """
...
class CustomSnapshotExtension(AmberSnapshotExtension):
    """Custom extension for Syrupy."""

    VERSION = "1"
    """Current version of serialization format.

    Need to be bumped when we change the CustomSnapshotSerializer.
    """

    serializer_class: type[AmberDataSerializer] = CustomSnapshotSerializer
